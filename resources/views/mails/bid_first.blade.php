...
<p>Thank you for participating in Value Auction and placing your bid. Details of your bid registered with us are as below. </p>
<ul><li>Your choice of Project     :  {{ $user->project->name }}</li>
