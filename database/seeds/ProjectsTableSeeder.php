...
class ProjectsTableSeeder extends Seeder
{
	...
	public function run()
	{
        ...
        Project::create([ 
        	...
        	"market_base" => "Rs 5100 - 6350 per sq ft",
        	"market_total" => "Rs 81.8 - 91.1 lacs",
        	"dev_base" => "Rs 5220  per sq ft",
        	"dev_total" => "Rs 75.8 - 78.1 lacs",
        	"hdfc_base" => "Rs 4250 per sq ft",
        ...
        // 	"video_url" => "",
        // 	"banner_text" => "SAVE RS. 4.6 LAKHS (Approx)",
        // 	"market_base" => "Rs 5000 - 6400 per sq ft",
        // 	"market_total" => "Rs 81.8 - 91.1 lacs",
        // 	"dev_base" => "Rs 6400 per sq ft",
        // 	"dev_total" => "Rs 75.8 - 78.1 lacs",
        // 	"hdfc_base" => "Rs 5500 per sq ft",
        // 	"hdfc_total" => "Rs 74.7- 77.7 lacs",
        // ]);
        ...
        Project::create([ 
        	...
        	"city" => "Bangalore",
        	"description" => "<ul><li>Unit Type: 3 BHK Comfort (approx. 1075 sq ft)</li> <li>Located near Bangalore International Airport.</li> <li>Just minutes away from Corporate hubs like ITIR, Apparel Park, Aerospace SEZ etc.</li> <li>Direct connectivity to one of the busiest upcoming commercial hubs, Hebbal.</li> <li>Equipped with all modern lifestyle amenities including a 9000 sft swimming pool.</li></ul>",
        	...
        	"banner_text" => "SAVE RS. 4.6 LAKHS (Approx)",
        	"market_base" => "Rs 3600 - 4400 per sq ft",
        	"market_total" => "Rs 81.8 - 91.1 lacs",
        	"dev_base" => "Rs 3654 per sq ft",
        	"dev_total" => "Rs 75.8 - 78.1 lacs",
        	"hdfc_base" => "Rs 3150 per sq ft",
        	"hdfc_total" => "Rs 74.7- 77.7 lacs",
        ]);
        ...
        Project::create([ 
        	...
        	"location" => "OMR",
        	"city" => "Chennai",
        	"description" => "<ul><li>Unit Type: 3 BHK Comfort (approx. 1740 sq ft)</li><li>3 BHK Homes on OMR overlooking the Muttukadu Lake.</li> <li>World class lifestyle amenities like swimming pool, gymnasium, multi-purpose hall, squash court, Basketball, table tennis, jogging track, steam & sauna, etc.</li></ul>",
        	"image_url" => "Swanlake.jpg",
        	"brochure_url" => "http://www.puravankara.com/Areas/Microsite/Content/Documents/Broucher/10/Swanlake.pdf",
        	"video_url" => "",
        	"banner_text" => "",
        	"market_base" => "Rs 3675 - 4500 per sq ft",
        	"market_total" => "Rs 81.8 - 91.1 lacs",
        	"dev_base" => "Rs 4199 per sq ft",
        	"dev_total" => "Rs 75.8 - 78.1 lacs",
        	"hdfc_base" => "Rs 3250 per sq ft",
        	"hdfc_total" => "Rs 74.7- 77.7 lacs",
        ]);
        ...
        Project::create([ 
        	...
        	"banner_text" => "SAVE RS. 4.6 LAKHS (Approx)",
        	"market_base" => "Rs 3750 - 4200 per sq ft",
        	"market_total" => "Rs 81.8 - 91.1 lacs",
        	"dev_base" => "Rs 4000 per sq ft",
        	"dev_total" => "Rs 75.8 - 78.1 lacs",
        	"hdfc_base" => "Rs 3300 per sq ft",
        	"hdfc_total" => "Rs 74.7- 77.7 lacs",
        ]);
        ...
        // 	"banner_text" => "SAVE RS. 4.6 LAKHS (Approx)",
        // 	"market_base" => "Rs 8500 - 12000 per sq ft",
        // 	"market_total" => "Rs 81.8 - 91.1 lacs",
        // 	"dev_base" => "Rs 10000 per sq ft",
        // 	"dev_total" => "Rs 75.8 - 78.1 lacs",
        // 	"hdfc_base" => "Rs 8500 per sq ft",
        // 	"hdfc_total" => "Rs 74.7- 77.7 lacs",
        // ]);
        ...
        Project::create([ 
                ...
                "location" => "Marine Drive ",
                "city" => "Kochi",
                "description" => "<ul><li>Unit Type: 3 BHK Grand (approx. 1925 sq ft)</li></ul>",
                "image_url" => "Purva Grandbay.jpg",
                "brochure_url" => "http://www.puravankara.com/Areas/Microsite/Content/Documents/Broucher/12/Purva%20GrandBay%20&%20Oceana%20brochure.pdf",
                "video_url" => "https://www.youtube.com/watch?v=dK9vnaXisJU",
                "banner_text" => "SAVE RS. 4.6 LAKHS (Approx)",
                "market_base" => "Rs 5200 - 6800 per sq ft",
                "market_total" => "Rs 81.8 - 91.1 lacs",
                "dev_base" => "Rs 6440 per sq ft",
                "dev_total" => "Rs 75.8 - 78.1 lacs",
                "hdfc_base" => "Rs 5250 per sq ft",
                "hdfc_total" => "Rs 74.7- 77.7 lacs",
        ]);
        ...
        Project::create([ 
                ...
                "location" => "OMR",
                "city" => "Chennai",
                "description" => "<ul><li>Unit Type: 3 BHK Grand (approx.1800 sq ft)</li> <li>3 BHK Homes on OMR overlooking the Muttukadu Lake.</li> <li>World class lifestyle amenities like swimming pool, gymnasium, multi-purpose hall, squash court, Basketball, table tennis, jogging track, steam & sauna, etc.</li></ul>",
                "image_url" => "Swanlake.jpg",
                "brochure_url" => "http://www.puravankara.com/Areas/Microsite/Content/Documents/Broucher/10/Swanlake.pdf",
                "video_url" => "",
                "banner_text" => "",
                "market_base" => "Rs 3675 - 4500 per sq ft",
                "market_total" => "Rs 81.8 - 91.1 lacs",
                "dev_base" => "Rs 4399 per sq ft",
                "dev_total" => "Rs 75.8 - 78.1 lacs",
                "hdfc_base" => "Rs 3490 per sq ft",
                "hdfc_total" => "Rs 74.7- 77.7 lacs",
        ]);
	}
}
